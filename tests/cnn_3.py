"""
CNN Model 3 for CIFAR-10 Classification
=======================================

This script defines, trains, validates, and evaluates a Convolutional Neural Network (CNN)
on the CIFAR-10 dataset using PyTorch. It uses additional data augmentation techniques
compared to previous models. The best model (lowest validation loss) is saved.
