"""
CNN Model 4 Training Script for CIFAR-10 Classification
=======================================================

This script defines, trains, and validates a Convolutional Neural Network (CNN) on the
CIFAR-10 dataset using PyTorch. It uses advanced data augmentation, learning rate scheduling,
and saves the best model based on validation loss improvement.
